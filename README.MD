...
Required screenshots (used by this README) are in the `images` folder:
...
Create a mobile-first alumni portal with authentication, a dashboard, a job board, a profile page, and bottom navigation.
